...
class NonCharacter(Node):
    ...
    def cost(self):
        """返回不可购买"""
        return'不可购买' if self._cost == 999999 else str(self._cost) + '金币'
...
class Characters(object):
    ...
    def __init__(self, characters_filename=unicode("data/Pack", 'utf8'),
